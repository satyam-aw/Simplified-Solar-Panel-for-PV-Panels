...
% --- Title Block ---
\title{\textbf{Simplified Dual-Axis Solar Tracker Using Arduino and LDRs} \\ Capstone Project for Embedded Systems Laboratory EE39004}
\author{
    Group 5:
...
\noindent A video demonstrating the operational prototype can be accessed via the following link: \url{https://www.youtube.com/watch?v=yR4f5ZiOPAA}.
